...
void UW_UI_Cpp::NativeConstruct()
{
...
void UW_UI_Cpp::Dialogue()
{
	//W_DialogueWidget->Show();
...
void UW_UI_Cpp::SetSingleShots1()
{
	W_Crosshair->SetSingleShots();
}

void UW_UI_Cpp::SetAutoShots1()
{
	W_Crosshair->SetAutoShots();
}

void UW_UI_Cpp::UpdateCrosshairHealthBar(float value)
{
	W_Crosshair->UpdateHealthBar(value);
}

void UW_UI_Cpp::UpdateCrosshairStaminaBar(float value)
{
	W_Crosshair->UpdateStaminaBar(value);
}

void UW_UI_Cpp::UpdateInventoryHealthBar(float value)
{
	W_Inventory->UpdateHealthBar1(value);
}

void UW_UI_Cpp::UpdateCroshairReleasedAmmo(float value)
{
	W_Crosshair->UpdateReleasedAmmo(value);
}

void UW_UI_Cpp::UpdateCroshairWeaponAmmo(float value)
{
	W_Crosshair->UpdateAmmoInWeapon(value);
}
